...
def get_filters():
    ...
    print('This application will provide data on the most popular bikeshare stations, trip duration, and user statistics in a US City by month and day of the week')
    # 1.) get user input for city

    city_list=["chicago", "new york city", "washington"]
    print('Please enter a city: Chicago, New York City, Washington')
    city=input().lower()
    
    #prompt them for correct input if it wasnt received
    while city not in city_list:
        print('Please enter a valid city: Chicago, New York City, or Washington')
        city=input().lower()

    # 2.) get user input for month (code is essentially duplicative to 1.)
    ...
    # 3.) get user input for day of week (code is essentially duplicative to 1 & 2)
...
def load_data(city, month, day):
    ...
    #Script prompts the user if they want to see 5 lines of raw data and continues to prompt user until user says no
...
def trip_duration_stats(df):
    ...
    #Create day, hour, minute, and second variables for 'total time'
    #Note that Trip Duration is in seconds 
    ...
    #Create day, hour, minute, and second variables for 'mean time' 
...
def main():
    """Runs the previously defined functions and displays output"""
    while True:
